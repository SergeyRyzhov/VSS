...
namespace Buddy.Placer
{
    ...
    //        double[] resultY;
    //
    //        PlaceGraph(symmetricGraph.VerticesAmount, symmetricGraph.Radius, symmetricGraph.Adjency, symmetricGraph.XAdj, symmetricGraph.Weight, width,
    ...
    //
    //        var dec = new ReducedGraph(symmetricGraph);
